...
public class OffScreenIndicator : MonoBehaviour {
    [SerializeField] private Vector3 onScreenIndicatorOffset;
    [Range(0.5f, 0.9f)]
    ...
    private void Awake(){
        ...
        screenCentre = new Vector3(Screen.width / 2f, Screen.height / 2f, 0);
    ...
    private void DrawIndicators(){
        foreach(Target target in targets){
            Vector3 screenPosition = OffScreenIndicatorCore.GetScreenPosition(mainCamera, target.transform.position + onScreenIndicatorOffset);
